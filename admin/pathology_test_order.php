            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" readonly class="form-control form-control-sm" name="date" value="<?php echo date("Y-d-m");?>" required />
                  </div>
                </div>
                <div class="form-group row">
                  <label for="fullname" class="col-sm-3 text-right">Customer Name <span>*</span></label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-sm" name="customer_name" value="" required />
                  </div>
                </div>
              <!-- /.box-body -->
              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      ...
                      <center style="padding:10px;"><button id="add" class="btn btn-success">Add Item</button> <button id="remove" class="btn btn-danger">Remove</button></center>
                    </div>
                  </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control form-control-sm" name="net_total" id="net_total" required />
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control form-control-sm" name="due" id="due" required/>
                </div>
              </div>
              <div class="form-group row">
