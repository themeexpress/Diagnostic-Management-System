...
<head>
	...
	<title>Dignostic Inventory Management System</title>
			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>Saidur Rahman</p>
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>Admin (All Privileges)</p>
				...
				<div class="jumbotron" style="width:100%;height:100%;">
					...
					<div class="row">
						<div class="col-sm-6">							
							<div class="card">
						      <div class="card-body">
						        <h4 class="card-title">Anual Report </h4>
						        <p class="card-text">Here you can See All Reports of Diagnostic Management System</p>
						        <a href="all_reports.php" class="btn btn-primary">Reports</a>
						      </div>
						    </div>
						</div>
