<?php include('usersincludes/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
    	<?php include_once("./database/newconstant.php");?>
	 ...
	 <div class="container">
		<div class="row">
			<div class="col-md-12 mx-auto">
				<div class="card" style="box-shadow:0 0 25px 0 lightgrey; padding: 10px;">
		...
		<!--<tr>
		    ...
		    <td>Rs.1540</td>
                    ...
                    <div class="form-group row">
                      <label for="gst" class="col-sm-3 col-form-label" align="right">VAT (15%)</label>
                      <div class="col-sm-6">
